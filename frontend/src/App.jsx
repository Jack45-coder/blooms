...
import { api, postForm } from "./apiClient";
    ...
    try {
      switch (modalType) {
        ...
        case "subcategory-edit":
          await api.put(`/subcategories/${modalData.id}`, modalData);
      ...
      {manageTab === "subcategories" && (
        <div className="grid">
          ...
          <div className="card">
            ...
            <p className="form-help">
              The backend currently does not expose GET/PUT/DELETE endpoints for
              subcategories, so this section is a placeholder to discuss what
              those APIs would look like in a real system.
            </p>
            <ul className="list">
              <li className="list-item">
                <div className="muted small">
                  Imagine rows here coming from{" "}
                  <code>GET /api/subcategories</code>, with buttons calling{" "}
                  <code>PUT /api/subcategories/&#123;id&#125;</code> and{" "}
                  <code>DELETE /api/subcategories/&#123;id&#125;</code>.
                </div>
              </li>
            </ul>
          </div>
